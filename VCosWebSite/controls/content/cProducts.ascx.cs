...
public partial class controls_content_cProducts : System.Web.UI.UserControl
{
    ...
    {
        iPROCAT = (Request.QueryString["CATID"] == null ? "0" : Request.QueryString["CATID"]);           
        if (Utilities.IsNumeric(iPROCAT))
            LoadProducts(Convert.ToInt32(iPROCAT));
        else
            LoadProducts(0);       
