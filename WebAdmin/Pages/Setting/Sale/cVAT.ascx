<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cVAT.ascx.cs" Inherits="Pages_Setting_Sale_cVAT" %>
        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a runat="server" href="~/?module=1012">Vận chuyển</a></li>
                    <li class="active"><a>Thuế VAT</a></li>
                </ul>
            </div>
                                ...
                                <telerik:RadGrid ID="RadGrid1" ClientInstanceName="RadGrid1" runat="server" EnableEmbeddedSkins="false"  
                                    ...
                                    <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="VATName" UniqueName="VATName" HeaderText="Loại VAT" ShowFilterIcon="false">
