<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cVATAlter.ascx.cs" Inherits="Pages_Setting_Sale_cVATAlter" %>
                ...
                <div role="form" class="form-custom">
                    <div class="box-body">
                        <div class="form-group">
					        <label>Tên VAT</label>
					        <input runat="server" id="fVATName" class="form-control" placeholder="">
				        </div>
				        <div class="form-group">
					        <label>Giá trị</label>
					        <input runat="server" id="fValue" class="form-control" placeholder="">
				        </div>
                    </div><!-- /.box-body -->
