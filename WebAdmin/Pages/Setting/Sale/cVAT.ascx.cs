...
public partial class Pages_Setting_Sale_cVAT : TUserControlForList
{
    DAVAT tData = new DAVAT();
    ...
    override protected Boolean LoadData()
    {
        try
        {
            RadGrid1.DataSource = tData.USP_VAT_GetAll(0, 0);
            RadGrid1.DataBind();
    ...
    override protected int DeleteByID(int pID)
    {
        try
        {
            return tData.USP_VAT_Delete(pID);
        }
        catch { return 0; }
    }
