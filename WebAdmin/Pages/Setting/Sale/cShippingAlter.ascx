<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cShippingAlter.ascx.cs" Inherits="Pages_Setting_Sale_cShippingAlter" %>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>
        <i class="fa fa-edit"></i>
        Chỉnh sửa hình thức vận chuyển
    </h1>
    <ol class="toolbar">
        <!-- fa-mail-reply -->
                ...
                <div role="form" class="form-custom">
                    <div class="box-body">
                        <div class="form-group">
					        <label>Hình thức vận chuyển đơn hàng</label>
					        <input runat="server" id="fShipping" class="form-control" placeholder="">
				        </div>
				        <div class="form-group">
					        <label>Mô tả</label>
