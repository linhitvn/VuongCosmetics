<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cPayment.ascx.cs" Inherits="Pages_Setting_Sale_cPayment" %>
                                ...
                                <telerik:RadGrid ID="RadGrid1" ClientInstanceName="RadGrid1" runat="server" EnableEmbeddedSkins="false"  
                                        ...
                                        <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="Payment" UniqueName="Payment" HeaderText="Hình thức thành toán" ShowFilterIcon="false">
