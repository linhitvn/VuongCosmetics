<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cLogTable.ascx.cs" Inherits="Pages_Setting_cLogTable" %>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>
        <i class="fa fa-list"></i>
        Quản lý ghi Log dữ liệu
    </h1>
    <ol class="toolbar">
        ...
        <li>
            <button visible="false" runat="server" id="btDelete" onserverclick="Delete_Click" class="btn btn-info btn-sm">
                        ...
                        <telerik:RadGrid ID="RadGrid1" ClientInstanceName="RadGrid1" runat="server" EnableEmbeddedSkins="false"  
                                ...
                                <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="TableName" UniqueName="TableName" HeaderText="Tên bảng dữ liệu" ShowFilterIcon="false">
                                        ...
                                        <telerik:GridTemplateColumn ShowFilterIcon="false" AllowFiltering="false" HeaderText="Kích hoạt" HeaderStyle-HorizontalAlign="Center" >
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkActive" runat="server" Enabled="false" Checked='<%# Eval("is_visibled") %>' />                        
                                            </ItemTemplate>
