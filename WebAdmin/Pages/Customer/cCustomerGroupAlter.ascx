<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cCustomerGroupAlter.ascx.cs" Inherits="Pages_Customer_cCustomerGroupAlter" %>
                ...
                <div role="form" class="form-custom">
                    <div class="box-body">
                        <div class="form-group">
					        ...
					        <input runat="server" id="fCustomerGroup" class="form-control" placeholder="">
				        </div>
				        <div class="form-group">
					        <label>Mô tả</label>
