<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cCustomerGroup.ascx.cs" Inherits="Pages_Customer_cCustomerGroup" %>
                        ...
                        <telerik:RadGrid ID="RadGrid1" ClientInstanceName="RadGrid1" runat="server" EnableEmbeddedSkins="false"  
                                ...
                                <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="CustomerGroup" UniqueName="CustomerGroup" HeaderText="Nhóm khách hàng" ShowFilterIcon="false">
