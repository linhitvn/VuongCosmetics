<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lockscreen.aspx.cs" Inherits="Pages_Outer_lockscreen" %>
...
<html class="lockscreen">
    ...
    <body>
        ...
        <div class="center">            
            ...
            <!-- User name -->
            <div runat="server" id="userName" class="lockscreen-name">John Doe</div>
                ...
                <div class="lockscreen-credentials">   
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            <button runat="server" onserverclick="Login_Click" class="btn btn-flat"><i class="fa fa-arrow-right text-muted"></i></button>
                        </div>
                    </div>
            ...
            <div class="lockscreen-link">
                <a runat="server" id="errorMes" href="#"></a>
