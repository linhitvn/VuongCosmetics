<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cProductOptionGroupAlter.ascx.cs" Inherits="Pages_Product_cProductOptionGroupAlter" %>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>
        <i class="fa fa-edit"></i>
        Chỉnh sửa nhóm tùy chọn sản phẩm
    </h1>
    <ol class="toolbar">
        <!-- fa-mail-reply -->
                ...
                <div role="form" class="form-custom">
                    <div class="box-body">
                        <div class="form-group">
					        <label>Nhóm tùy chọn sản phẩm</label>
					        <input runat="server" id="fProductOptionGroup" class="form-control" placeholder="">
				        </div>
				        <div class="form-group">
					        <label>Loại nhóm</label>
					        <select runat="server" id="fRecordTypeID" datatextfield="RecordType" datavaluefield="ID" class="form-control"></select>
				        </div>
                         <div class="form-group">
					        <label>Mô tả</label>
					        <textarea runat="server" id="fDescription" class="form-control" rows="3" placeholder=""></textarea>
				        </div>
                    </div><!-- /.box-body -->
