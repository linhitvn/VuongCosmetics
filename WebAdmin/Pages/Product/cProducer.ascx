<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cProducer.ascx.cs" Inherits="Pages_Product_cProducer" %>
                        ...
                        <telerik:RadGrid ID="RadGrid1" ClientInstanceName="RadGrid1" runat="server" EnableEmbeddedSkins="false"  
                                ...
                                <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="ProducerName" UniqueName="ProducerName" HeaderText="Nhà sản xuất" ShowFilterIcon="false">
				                        ...
				                        <telerik:GridBoundColumn DataField="Website" UniqueName="Website" HeaderText="Website" ShowFilterIcon="false">
