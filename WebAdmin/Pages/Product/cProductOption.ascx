<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cProductOption.ascx.cs" Inherits="Pages_Product_cProductOption" %>
        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a>Tùy chọn sản phẩm</a></li>
                    <li class=""><a id="A2" runat="server" href="~/?module=308">Nhóm Tùy Chọn sản phẩm</a></li>
                </ul>
            </div>
                            ...
                            <div id="Div1" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="ProductOption" UniqueName="ProductOption" HeaderText="Tùy chọn" ShowFilterIcon="false">
					                        <HeaderStyle Width="50%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="Value" UniqueName="Value" HeaderText="Giá trị" ShowFilterIcon="false">
