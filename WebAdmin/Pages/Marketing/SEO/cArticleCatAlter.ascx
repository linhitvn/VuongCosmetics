<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cArticleCatAlter.ascx.cs" Inherits="Pages_Marketing_SEO_cArticleCatAlter" %>
        ...
        <div class="col-xs-12">
           <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a id="A3" runat="server" href="~/?module=523">Danh mục sản phẩm</a></li>
                    <li class="active"><a>Danh mục tin tức</a></li>
                </ul>
            </div>
                        ...
                        <div class="box-body">
                            <div role="form" class="form-custom">
                                <div class="form-group">
					                ...
					                <input disabled="disabled" runat="server" id="fCategory" class="form-control" placeholder="">
				                </div>
                                <div class="form-group">
					                <label>Tiêu đề</label>
