<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cArticleCat.ascx.cs" Inherits="Pages_Marketing_SEO_cArticleCat" %>
<style type="text/css">
...
<section class="content-header">
    <h1>
        ...
        Thiết lập SEO Cho Danh mục bài viết
    </h1>
    <ol class="toolbar">
        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a id="A3" runat="server" href="~/?module=513">Thiết lập SEO Cho Trang</a></li>
