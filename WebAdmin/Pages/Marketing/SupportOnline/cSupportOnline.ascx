<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cSupportOnline.ascx.cs" Inherits="Pages_Marketing_SupportOnline_cSupportOnline" %>
                        ...
                        <telerik:RadGrid ID="RadGrid1" ClientInstanceName="RadGrid1" runat="server" EnableEmbeddedSkins="false"  
                                ...
                                <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="SupportName" UniqueName="SupportName" HeaderText="Tên hiển thị" ShowFilterIcon="false">
					                        <HeaderStyle Width="20%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
				                        <telerik:GridBoundColumn DataField="Phone" UniqueName="Phone" HeaderText="Điện thoại" ShowFilterIcon="false">
					                        <HeaderStyle Width="15%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
				                        <telerik:GridBoundColumn DataField="Email" UniqueName="Email" HeaderText="Email" ShowFilterIcon="false">
					                        <HeaderStyle Width="15%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
				                        <telerik:GridBoundColumn DataField="Skype" UniqueName="Skype" HeaderText="Skype" ShowFilterIcon="false">
					                        <HeaderStyle Width="15%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
				                        <telerik:GridBoundColumn DataField="Yahoo" UniqueName="Yahoo" HeaderText="Yahoo" ShowFilterIcon="false">
					                        <HeaderStyle Width="15%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
