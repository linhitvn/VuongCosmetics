<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cPage.ascx.cs" Inherits="Pages_SysCategory_cPage" %>
                        ...
                        <telerik:RadGrid ID="RadGrid1" ClientInstanceName="RadGrid1" runat="server" EnableEmbeddedSkins="false"  
                                ...
                                <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                    <Columns>
				                        ...
				                        <telerik:GridBoundColumn DataField="UControl" UniqueName="UControl" HeaderText="Đường dẫn Control" ShowFilterIcon="false">
					                        <HeaderStyle Width="20%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
				                        <telerik:GridBoundColumn DataField="Param" UniqueName="Param" HeaderText="Thông số Trang" ShowFilterIcon="false">
					                        <HeaderStyle Width="20%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
