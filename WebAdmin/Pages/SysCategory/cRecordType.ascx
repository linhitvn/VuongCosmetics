<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cRecordType.ascx.cs" Inherits="Pages_SysCategory_cRecordType" %>
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>
        <i class="fa fa-list"></i>
        Danh mục Record Type
    </h1>
    <ol class="toolbar">
                        ...
                        <telerik:RadGrid ID="RadGrid1" ClientInstanceName="RadGrid1" runat="server" EnableEmbeddedSkins="false"  
                                ...
                                <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="TableName" UniqueName="TableName" HeaderText="TableName" ShowFilterIcon="false">
					                        <HeaderStyle Width="30%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="RecordType" UniqueName="RecordType" HeaderText="RecordType" ShowFilterIcon="false">
					                        <HeaderStyle Width="30%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
