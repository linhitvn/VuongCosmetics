<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cOrderStatus.ascx.cs" Inherits="Pages_SysCategory_OrderStatus" %>
                        ...
                        <telerik:RadGrid ID="RadGrid1" ClientInstanceName="RadGrid1" runat="server" EnableEmbeddedSkins="false"  
                                ...
                                <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="OrderStatus" UniqueName="OrderStatus" HeaderText="Trang thái đơn hàng" ShowFilterIcon="false">
