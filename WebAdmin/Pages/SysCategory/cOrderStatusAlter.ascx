<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cOrderStatusAlter.ascx.cs" Inherits="Pages_SysCategory_OrderStatusAlter" %>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>
        <i class="fa fa-edit"></i>
        Chỉnh sửa trang thái đơn hàng
    </h1>
    <ol class="toolbar">
        <!-- fa-mail-reply -->
                ...
                <div role="form" class="form-custom">
                    <div class="box-body">
                        <div class="form-group">
					        ...
					        <input runat="server" id="fOrderStatus" class="form-control" placeholder="">
				        </div>
				        <div class="form-group">
					        <label>Mô tả</label>
				        ...
				        <div class="form-group">
					        <label>Vị trí</label>
					        <input runat="server" id="fPos" class="form-control input-number" placeholder="Vị trí hiển thị trên ComboBox">
				        </div>
                    </div><!-- /.box-body -->
