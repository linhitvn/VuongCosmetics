<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cRecordTypeAlter.ascx.cs"
    Inherits="Pages_SysCategory_cRecordTypeAlter" %>
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>
        <i class="fa fa-edit"></i>
        Chỉnh sửa danh mục Record Type
    </h1>
    <ol class="toolbar">
        <!-- fa-mail-reply -->
                ...
                <div role="form" class="form-custom">
                    <div class="box-body">
                        <div class="form-group">
					        <label>Tên Loại Record</label>
					        <input runat="server" id="fRecordType" class="form-control" placeholder="">
				        </div>
				        <div class="form-group">
					        <label>Thuộc Table (Tên Table)</label>
					        <input runat="server" id="fTableName" class="form-control" placeholder="">
				        </div>
				        <div class="form-group">
					        <label>Mô tả</label>
