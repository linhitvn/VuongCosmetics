<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cProvince.ascx.cs" Inherits="Pages_SysCategory_cProvince" %>
                        ...
                        <telerik:RadGrid ID="RadGrid1" ClientInstanceName="RadGrid1" runat="server" EnableEmbeddedSkins="false"  
                                ...
                                <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="Province" UniqueName="Province" HeaderText="Tỉnh/ Thành phố" ShowFilterIcon="false">
					                        <HeaderStyle Width="30%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
				                        <telerik:GridCheckBoxColumn DataField="IsAllowShipping" UniqueName="IsAllowShipping" HeaderText="nhận giao hàng" ShowFilterIcon="false" ReadOnly="True">
					                        <HeaderStyle Width="30%" HorizontalAlign="Center" />
					                        <ItemStyle HorizontalAlign="Center" />
				                        </telerik:GridCheckBoxColumn>
				                        <telerik:GridCheckBoxColumn DataField="IsAllowBilling" UniqueName="IsAllowBilling" HeaderText="thanh toán hóa đơn" ShowFilterIcon="false" ReadOnly="True">
					                        <HeaderStyle Width="30%" HorizontalAlign="Center" />
					                        <ItemStyle HorizontalAlign="Center" />
				                        </telerik:GridCheckBoxColumn>
