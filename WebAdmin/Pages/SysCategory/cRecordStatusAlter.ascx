<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cRecordStatusAlter.ascx.cs"
    Inherits="Pages_SysCategory_cRecordStatusAlter" %>
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>
        <i class="fa fa-edit"></i>
        Chỉnh sửa danh mục Record Status
    </h1>
    <ol class="toolbar">
        <!-- fa-mail-reply -->
                ...
                <div role="form" class="form-custom">
                    <div class="box-body">
                        <div class="form-group">
					        <label>Trạng thái Record</label>
					        <input runat="server" id="fRecordStatus" class="form-control" placeholder="">
				        </div>
				        <div class="form-group">
