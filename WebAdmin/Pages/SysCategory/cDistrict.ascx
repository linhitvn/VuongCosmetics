<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cDistrict.ascx.cs" Inherits="Pages_SysCategory_cDistrict" %>
                        ...
                        <telerik:RadGrid ID="RadGrid1" ClientInstanceName="RadGrid1" runat="server" EnableEmbeddedSkins="false"  
                                ...
                                <MasterTableView DataKeyNames="ID" ShowHeadersWhenNoRecords="true" CssClass="table table-bordered table-striped dataTable">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="District" UniqueName="District" HeaderText="Quận/ Huyện" ShowFilterIcon="false">
					                        <HeaderStyle Width="50%" HorizontalAlign="Center" /> 
				                        </telerik:GridBoundColumn>
				                        <telerik:GridBoundColumn DataField="Province" UniqueName="Province" HeaderText="Tỉnh thành" ShowFilterIcon="false">
