<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill.aspx.cs" Inherits="InvoiceTemplate_Bill" %>
...
<head runat="server">
    ...
    <link runat="server" href="~/css/MyStyle.css" rel="stylesheet" type="text/css" />
                            ...
                            <div class="table-responsive">
                                <table class="table priceTotal">
                                    <tr>
                                        ...
                                        <td runat="server" id="fTotalPrice"></td>
                                    </tr>
                                    <tr>
                                        <th>Khuyến mãi giảm giá</th>
                                        <td runat="server" id="fDiscount"></td>
                                    </tr>
                                    <tr>
                                        <th>Phí vận chuyển</th>
                                        <td runat="server" id="fShippingPrice"></td>
                                    </tr>
                                    <tr>
                                        <th>Tổng cộng:</th>
                                        <td runat="server" id="fTotalNeedPay"></td>
                                    </tr>
                                </table>
                            </div>
                        </div><!-- /.col -->
