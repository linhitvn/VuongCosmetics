...
public partial class Pages_Menu_cMenu : TUserControlForList
{
    DAMenu tData = new DAMenu();
    ...
    override protected Boolean LoadData()
    {
        try
        {
            RadGrid1.DataSource = tData.USP_Menu_GetAll(0, 0);
            RadGrid1.DataBind();
    ...
    override protected int DeleteByID(int pID)
    {
        try
        {
            return tData.USP_Menu_Delete(pID);
        }
        catch { return 0; }
    }
