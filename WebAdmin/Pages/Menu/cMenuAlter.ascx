<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cMenuAlter.ascx.cs" Inherits="Pages_Menu_cMenuAlter" %>
                ...
                <div role="form" class="form">
                    <div class="box-body">
                        <div class="form-group">
					        ...
					        <input runat="server" id="fMenuName" class="form-control" placeholder="">
				        </div>
				        <div class="form-group">
					        <label>Mô tả</label>
